Shader "Unreal/M_Props2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Props2_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Props2_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Props2_OcclusionRoughnessMetallic", 2D ) = "white" {}
