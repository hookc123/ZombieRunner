Shader "Unreal/M_Props1"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Props1_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Props1_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Props1_OcclusionRoughnessMetallic", 2D ) = "white" {}
